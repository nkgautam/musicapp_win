...
namespace MusicApp
{
    ...
    public sealed partial class App : Application
    {
        ...
        public async void CreateUserDatabase()
        {
        ...
        public async void CreateRecordDatabase()
        {
...
#endif
            bool databaseUserExist = await DoesDbExist("user.db");
            if (!databaseUserExist)
            {
                CreateUserDatabase();
            }

            bool databaseRecordExist = await DoesDbExist("record.db");
